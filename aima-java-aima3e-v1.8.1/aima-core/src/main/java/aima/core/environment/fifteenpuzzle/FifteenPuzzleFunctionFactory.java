...
public class FifteenPuzzleFunctionFactory {
	...
	private static class EPActionsFunction implements ActionsFunction { //ACCIONES APLIABLES A UN ESTADO
	...
	private static class EPResultFunction implements ResultFunction { //FUNCIÓN DE TRANSICIÓN
